...
-- ke me tao
    ...
    SubTitle = "version nhieu thi ke me tao",
    TabWidth = 160,
    Size = UDim2.fromOffset(530, 350),
    Acrylic = true, 
    Theme = "Darker",
    MinimizeKey = Enum.KeyCode.Ctrl
})
local Tabs = {
        ...
        if _G.AutoBone then
            pcall(function()
                ...
                if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false then
                    ...
                    if (BoneCFrame.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 500 then    
...
local killpl = Tabs.Race:AddToggle("killpl", {Title = "Auto Kill Kids After Trials", Default = false })
                    ...
                    for i, v in pairs(game:GetService("Workspace").Characters:GetChildren()) do
                        if v.Name ~= game.Players.LocalPlayer.Name and
                            ...
                            if v.Humanoid.Health > 0 then
                                ...
                                until not killpl or not v.Parent or v.Humanoid.Health <= 0
                            end
                        end
                    end
                end)
...
function comoon()
    Fluent:Notify({
        Title = "Lùa Hub",
        Content = "Turn Off Find Full Moon Becoz Full Moon rn",
        SubContent = "", -- Optional
