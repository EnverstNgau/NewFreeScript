...
local Tabs = {
    ...
    Player = Window:AddTab({ Title = "Local Players", Icon = "baby" }),
    Teleport = Window:AddTab({ Title = "Teleport", Icon = "palmtree" }),
    Fruit = Window:AddTab({ Title = "Devil Fruits", Icon = "cherry" }),
    Raid = Window:AddTab({ Title = "Raid", Icon = "swords" }),
    Race = Window:AddTab({ Title = "Mystic Island", Icon = "chevrons-right" }),
    Hop = Window:AddTab({ Title = "Server Status", Icon = "wifi" }),
    Shop = Window:AddTab({ Title = "Buy Items", Icon = "shopping-cart" }),
	Misc = Window:AddTab({ Title = "Miscellaneous", Icon = "list-plus" }),
}
local Options = Fluent.Options
function ditmeaimaneche()
    for i, v in pairs(game:GetService("Players").LocalPlayer.Character:GetDescendants()) do
        for i, x in pairs(game:GetService("Players").LocalPlayer.PlayerScripts:GetDescendants()) do
            if v:IsA("LocalScript") or x:IsA("LocalScript") then
                if v.Name == "General" or v.Name == "Shiftlock"  or v.Name == "FallDamage" or v.Name == "4444" or v.Name == "CamBob" or v.Name == "JumpCD" or v.Name == "Looking" or v.Name == "Run" then
                    v:Destroy()
                end
                if x.Name == "RobloxMotor6DBugFix" or x.Name == "Clans"  or x.Name == "Codes" or x.Name == "CustomForceField" or x.Name == "MenuBloodSp"  or x.Name == "PlayerList" then
                    x.Destroy()
                end
            end
        end
...
elseif a == 7449423635 then
    ...
    Game.Players.LocalPlayer:Kick("Just Supported Blox Fruits For This Script")
end
...
function CheckLevel()
    ...
    if First_Sea then
        ...
        elseif Lv == 449 or Lv <= 474 or SelectMonster == "God's Guard" or SelectArea == 'Sky Island' then -- God's Guard
            Ms = "God's Guard"
    ...
    if Second_Sea then
        ...
        elseif Lv == 1250 or Lv <= 1274 or SelectMonster == "Ship Deckhand" or SelectArea == 'Ship' then -- Ship Deckhand
            ...
            if _G.AutoLevel and (CFrameMon.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 2000 then
...
function toTarget(...)
    ...
    local tweenfunc = {}
    function ComOldNoCheckPath(a,b)
        game:GetService("ReplicatedStorage").Remotes.Comm[a]:InvokeServer(b)
        game:GetService("ReplicatedStorage").Remotes.Comm[a]:FireServer(b)
    end
    function Com(com, ...)
        ...
        if Distance > 3000 and not AutoNextIsland and not (game.Players.LocalPlayer.Backpack:FindFirstChild("Special Microchip") or game.Players.LocalPlayer.Character:FindFirstChild("Special Microchip") or game.Players.LocalPlayer.Backpack:FindFirstChild("God's Chalice") or game.Players.LocalPlayer.Character:FindFirstChild("God's Chalice") or game.Players.LocalPlayer.Backpack:FindFirstChild("Hallow Essence") or game.Players.LocalPlayer.Character:FindFirstChild("Hallow Essence") or game.Players.LocalPlayer.Character:FindFirstChild("Sweet Chalice") or game.Players.LocalPlayer.Backpack:FindFirstChild("Sweet Chalice")) and not (Name == "Fishman Commando" or Name == "Fishman Warrior") then
            pcall(function()
                ...
                if game:GetService("Players")["LocalPlayer"].Data:FindFirstChild("SpawnPoint").Value == tostring(GetIsLand(RealTarget)) then
                    wait(.1)
                    ComOldNoCheckPath("F_", "TeleportToSpawn")
                    wait()
...
function TweenShip(CFgo)
    local tween_s = game:service"TweenService"
    local info = TweenInfo.new((game:GetService("Workspace").Boats.MarineBrigade.VehicleSeat.CFrame.Position - CFgo.Position).Magnitude/320, Enum.EasingStyle.Linear)
    ...
    while task.wait() do
        pcall(function()
            if _G.BjirAnchorCuy or _G.AutoTeleportadc or _G.TweenToGear or _G.AutoCollectAzure or _G.TweenToKitsune or KillPlayer or _G.TeleportIsland or _G.AutoCandy or _G.GhostShip or _G.Ship or _G.SailBoat or _G.Auto_Holy_Torch or _G.FindMirageIsland or _G.TeleportPly or _G.Tweenfruit or _G.AutoFishCrew or _G.AutoShark or _G.AutoCakeV2 or _G.AutoMysticIsland or _G.AutoQuestRace or _G.AutoBuyBoat or _G.dao or _G.AutoMirage or AutoFarmAcient or _G.AutoQuestRace or Auto_Law or _G.AutoAllBoss or AutoTushita or _G.AutoHolyTorch or _G.AutoTerrorshark or _G.farmpiranya or _G.DriveMytic or _G.AutoCakeV2V2 or PirateShip or _G.AutoSeaBeast or _G.AutoNear or _G.BossRaid or _G.GrabChest or AutoCitizen or _G.Ectoplasm or AutoEvoRace or AutoBartilo or AutoFactory or BringChestz or BringFruitz or _G.AutoLevel or _G.Clip2 or AutoFarmNoQuest or _G.AutoBone or AutoFarmSelectMonsterQuest or AutoFarmSelectMonsterNoQuest or _G.AutoBoss or AutoFarmBossQuest or AutoFarmMasGun or AutoFarmMasDevilFruit or AutoFarmSelectArea or AutoSecondSea or AutoThirdSea or AutoDeathStep or AutoSuperhuman or AutoSharkman or AutoElectricClaw or AutoDragonTalon or AutoGodhuman or AutoRengoku or AutoBuddySword or AutoPole or AutoHallowSycthe or AutoCavander or AutoTushita or AutoDarkDagger or _G.CakePrince or _G.AutoElite or AutoRainbowHaki or AutoSaber or AutoFarmKen or AutoKenHop or AutoKenV2 or _G.AutoKillPlayerMelee or _G.AutoKillPlayerGun or _G.AutoKillPlayerFruit or AutoDungeon or AutoNextIsland or AutoAdvanceDungeon or Musketeer or RipIndra or Auto_Serpent_Bow or AutoTorch or AutoSoulGuitar or Auto_Cursed_Dual_Katana or _G.AutoMaterial or Auto_Quest_Yama_1 or Auto_Quest_Yama_2 or Auto_Quest_Yama_3 or Auto_Quest_Tushita_1 or Auto_Quest_Tushita_2 or Auto_Quest_Tushita_3 or _G.Factory or _G.SwanGlasses or AutoBartilo or AutoEvoRace or _G.Ectoplasm then
                ...
                until not game:GetService("Players").LocalPlayer.Character:FindFirstChild("Highlight") or not game:GetService("Players").LocalPlayer.Character.HumanoidRootPart:FindFirstChild("BodyClip")
            end
        end)
    end
end)
...
function s()
    ...
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetLastSpawnPoint",tostring(game:GetService("Players").LocalPlayer.Data.SpawnPoint.Value))
end
function wSmartTestPerson(TargetCF)
    t(TargetCF)
    task.wait()
    r()
    task.wait()
...
function vandoSmartestrielko(p)
    pcall(function()
        if (p.Position-game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude >= 3000 and not _G.Auto_StartRaid and game.Players.LocalPlayer.Character.Humanoid.Health > 0 then
...
ImageButton.Image = "rbxassetid://15297431935"
        ...
        if _G.AutoLevel then
            pcall(function()
                ...
                if not string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) or game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false then
                    ...
                    task.wait()
                    if SemiTeleport then
                        if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - CFrameQ.Position).Magnitude > 3000 then
                            wSmartTestPerson(CFrameQ)
                            task.wait()
                            vandoSmartestrielko(CframeQ)
                        elseif (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - CFrameQ.Position).Magnitude < 3000 then
                            Tween(CFrameQ)
                        end
                    else
                        Tween(CFrameQ)
                ...
                elseif string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) or game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                    ...
                    for i,v in pairs(game:GetService("Workspace")["_WorldOrigin"].EnemySpawns:GetChildren()) do
                        if string.find(v.Name,NameMon) then
                            if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v.Position).Magnitude >= math.huge then
...
local ToggleCandy = Tabs.Main:AddToggle("ToggleCandy", {Title = "Auto Farm Candy [ New ]", Default = false })
...
local Toggleautoanchor = Tabs.Main:AddToggle("Toggleautoanchor", {Title = "Auto Shark Anchor", Default = false })
Toggleautoanchor:OnChanged(function(Value)
    _G.BjirAnchorCuy = Value
end)
task.spawn(function()
    if _G.BjirAnchorCuy and findItem("Monster Magnet", 1) then
        _G.BjirAnchorCuy = true
    elseif _G.BjirAnchorCuy and findItem("Terror Eyes", 2) and findItem("Electric Wing", 8) and findItem("Fool's Gold", 20) and findItem("Shark Tooth", 10) then
        local args = {
            [1] = "CraftItem",
            [2] = "Check",
            [3] = "SharkAnchor"
        ...
        wait(0.5) 
        _G.BjirAnchorCuy = true
    elseif _G.BjirAnchorCuy and (not findItem("Monster Magnet", 1) or not findItem("Terror Eyes", 2) and not findItem("Electric Wing", 8) and not findItem("Fool's Gold", 20) and not findItem("Shark Tooth", 10)) then
...
if _G.BjirAnchorCuy then
    ...
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
    toTarget(CFrame.new(-30939.830078125, 3.729933261871338, 9256.4208984375))
...
Options.Toggleautoanchor:SetValue(false)
        ...
        if _G.AutoNear then
            pcall(function()
                for i,v in pairs (game.Workspace.Enemies:GetChildren()) do
                    if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                        if v.Name then
                            if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v:FindFirstChild("HumanoidRootPart").Position).Magnitude <= 50000 then
                                repeat wait()
                                    AutoHaki()
                                    EquipTool(SelectWeapon)
                                    Tween(v.HumanoidRootPart.CFrame * CFrame.new(posX,posY,posZ))
...
Tabs.Main:AddButton({
    Title = "Fps Booster",
    Description = "Boost your fps & Remove Terrain",
    Callback = function()
...
local DropdownMastery = Tabs.Main:AddDropdown("DropdownMastery", {
    ...
    Values = {"Level","Near Mob","Boss [ Gun Mastery ]"},
    Multi = false,
    Default = 1,
})
...
task.spawn(function()
    while task.wait(.1) do
                            ...
                            if v.Name == Ms then
                                repeat game:GetService("RunService").Heartbeat:wait()
                                    if v.Humanoid.Health <= v.Humanoid.MaxHealth * KillPercent / 100 then
                                        ...
                                        v.Humanoid.WalkSpeed = 0
                                        v.HumanoidRootPart.CanCollide = false
                                        FarmPosMasteryGun = v.Head.CFrame
                                        FarmPos = v.HumanoidRootPart.CFrame
                                        MonFarm = v.Name
                                    end
        ...
        elseif AutoFarmMasGun and TypeMastery == 'Boss [ Gun Mastery ]' then
                    ...
                    if game:GetService("Workspace").Enemies:FindFirstChild(SelectBoss) then
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v.Name == SelectBoss and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") then
                                ...
                                until not AutoFarmMasGun or not TypeMastery == 'Boss [ Gun Mastery ]' or not v.Parent or v.Humanoid.Health <= 0 or game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible == false or not game:GetService("Workspace").Enemies:FindFirstChild(v.Name)
                            end
                        end
                    else
                        UseSkillGun = false
...
task.spawn(function()
    game:GetService("RunService").RenderStepped:Connect(function()
        if UseSkillGun then
            pcall(function()
                for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                    if v.Name == MonFarm or v.Name == Ms then
                    ...
                    for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                        if v.Name == MonFarm and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health <= v.Humanoid.MaxHealth * KillPercent / 100 then
                            repeat game:GetService("RunService").Heartbeat:wait()
                                ...
                                Tween(v.HumanoidRootPart.CFrame * CFrame.new(posX,posY,posZ))
                                PositionSkillMasteryDevilFruit = v.HumanoidRootPart.Position or v.HumanoidRootPart.Cframe
        ...
        while task.wait() do
            if _G.AutoBone then
                pcall(function()
                    ...
                    if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false then
                        if SemiTeleport then
                            if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - BoneCFrame2.Position).Magnitude > 3000 then
                                wSmartTestPerson(BoneCFrame2)
                                vandoSmartestrielko(BoneCframe2)
                            elseif (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - BoneCFrame.Position).Magnitude < 3000 then
                                Tween(BoneCFrame)
                            end
                        else
                            Tween(BoneCFrame)
                        end
                    if (BoneCFrame.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 100 then    
        ...
        while task.wait() do
            if _G.CakePrince then
                pcall(function()
                    ...
                    if SemiTeleport then
                        if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - CakeCFrame.Position).Magnitude > 3000 then
                            wSmartTestPerson(CakeCFrame)
                            task.wait()
                            vandoSmartestrielko(CakeCframe)
                        elseif (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - CakeCFrame.Position).Magnitude < 3000 then
                            Tween(CakeCFrame)
                        end
                    end
    ...
    while task.wait() do
        if _G.AutoMaterial then
            pcall(function()
                ...
                if SemiTeleport then
                    if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - MPos.Position).Magnitude > 3000 then
                        wSmartTestPerson(MPos)
                        vandoSmartestrielko(MPos)
                    elseif (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - MPos.Position).Magnitude < 3000 then
                        Tween(MPos)
                    end
                else
                    Tween(MPos)
...
if Third_Sea then
    ...
    local ToggleCDK = Tabs.Main:AddToggle("ToggleCDK", {Title = "Auto Cursed Dual Katana", Default = false })
                            ...
                            for x,y in pairs(game:GetService("ReplicatedStorage"):GetChildren()) do
                                if y:FindFirstChild("HazeESP") then
                                    if (y.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 2000 then
                                        toTarget(y.HumanoidRootPart.CFrameMon* Farm_Mode)
                                    else
                                        toTarget(y.HumanoidRootPart.CFrame * Farm_Mode)
                                    end
                                end
                            end
                        end
        ...
        while wait() do
            pcall(function()
                if _G.BuyLengendSword or Triple_A then
                    ...
                    cac(bananadepzaihayvandodz[1])
                    cac(bananadepzaihayvandodz[2])
                    cac(bananadepzaihayvandodz[3])
                else
                    wait(2)
                end
            end)
...
local ToggleFastAttack = Tabs.Setting:AddToggle("ToggleFastAttack", {Title = " Enabled Fast Attack ", Default = true })
...
function getHits(Size)
    ...
    for i = 1, #Enemies do
        ...
        if Human and Human.RootPart and Human.Health > 0 and game.Players.LocalPlayer:DistanceFromCharacter(Human.RootPart.Position) < Size + 60 then
            table.insert(Hits, Human.RootPart)
        end
    end
    for i = 1, #Characters do
        local v = Characters[i]
        if v ~= game.Players.LocalPlayer.Character then local Human = v:FindFirstChildOfClass("Humanoid")
            if Human and Human.RootPart and Human.Health > 0 and game.Players.LocalPlayer:DistanceFromCharacter(Human.RootPart.Position) < Size + 60 then
                table.insert(Hits, Human.RootPart)
            end
        end
...
function Attack()
    ...
    task.spawn(function()
        if ac and ac.equipped then
            ac.activeController.focusStart = 0
            ac.activeController.hitSound = 0
            ac.hitboxMagnitude = 2480
    ...
    while task.wait() do
        if _G.FastAttack then
            pcall(function()
                ...
                ditmeae("Lùa Hub better than these kids hub name is crazzy hub dumbass")
            end)
        end
    end
end)                                                                                                                                                                                                                                                                                                                                                                              
            ...
            if _G.BringMob then
                for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                    if not string.find(v.Name,"Boss") then
                        if v.Name == MonFarm or v.Name == Ms or v.Name == NameMon then
                            if (v.HumanoidRootPart.Position - FarmPos.Position).magnitude <= 300 or (v.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame.Position).magnitude <= 300 then
...
local ToggleSemiTeleport = Tabs.Setting:AddToggle("ToggleSemiTeleport", {Title = "Enabled Fast Teleport", Default = true })
ToggleSemiTeleport:OnChanged(function(Value)
    SemiTeleport = Value
end)
Options.ToggleSemiTeleport:SetValue(false)
local ToggleRaceVBaVBon = Tabs.Setting:AddToggle("ToggleRaceVBaVBon", {Title = "Enabled Use Race When Farm", Default = true })
ToggleRaceVBaVBon:OnChanged(function(Value)
    UseRaceWhenFarm = Value
end)
Options.ToggleRaceVBaVBon:SetValue(false)
...
--Teleport
local Teleport = Tabs.Teleport:AddSection("Travel World")
...
local ToggleCollect = Tabs.Fruit:AddToggle("ToggleCollect", {Title = "Collect Fruits ( Very OP )", Default = false })
...
task.spawn(function()
    while wait() do
        if _G.Tweenfruit then
            for i,v in pairs(game.Workspace:GetChildren()) do
                if string.find(v.Name, "Fruit") then
                    v.Handle.Cframe = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame * Cframe.new(0,100,0)
                    wait(1)
...
local ToggleEspMirage = Tabs.Fruit:AddToggle("ToggleEspMirage", {Title = "Esp Mirage Island", Default = false })
ToggleEspMirage:OnChanged(function(Value)
    MirageIslandESP = Value
end)
Options.ToggleEspMirage:SetValue(false)

local ToggleEspAFD = Tabs.Fruit:AddToggle("ToggleEspAFD", {Title = "Esp Advanced Fruits Dealer", Default = false })
ToggleEspAFD:OnChanged(function(Value)
    AfdESP = Value
end)
Options.ToggleEspAFD:SetValue(false)

local ToggleEspAuraHaki = Tabs.Fruit:AddToggle("ToggleEspAuraHaki", {Title = "Esp Legendary Haki Dealer", Default = false })
ToggleEspAuraHaki:OnChanged(function(Value)
    AuraESP = Value
end)
Options.ToggleEspAuraHaki:SetValue(false)

local ToggleEspLADESP = Tabs.Fruit:AddToggle("ToggleEspLADESP", {Title = "Esp Legendary Advanced Dealer", Default = false })
ToggleEspLADESP:OnChanged(function(Value)
    LADESP = Value
end)
Options.ToggleEspLADESP:SetValue(false)

local ToggleEspGear = Tabs.Fruit:AddToggle("ToggleEspGear", {Title = "Esp Gear", Default = false })
ToggleEspLADESP:OnChanged(function(Value)
    GearESP = Value
end)
...
local ToggleAwake = Tabs.Raid:AddToggle("ToggleAwake", {Title = "Auto Awakening Fruit", Default = false })
...
Tabs.Race:AddButton({
    ...
    Description = "",
    Callback = function()
        Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame=CFrame.new(28286.35546875,14895.3017578125,102.62469482421875)wait(0.1)Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame=CFrame.new(28286.35546875,14895.3017578125,102.62469482421875)wait(0.1)Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame=CFrame.new(28286.35546875,14895.3017578125,102.62469482421875)wait(0.1)Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame=CFrame.new(28286.35546875,14895.3017578125,102.62469482421875)
        wait(0.5)
        if game:GetService("Players").LocalPlayer.Data.Race.Value=="Human" then Tween2(CFrame.new(29221.822265625,14890.9755859375,-205.99114990234375))elseif game:GetService("Players").LocalPlayer.Data.Race.Value=="Skypiea"then Tween2(CFrame.new(28960.158203125,14919.6240234375,235.03948974609375))elseif game:GetService("Players").LocalPlayer.Data.Race.Value=="Fishman"then Tween2(CFrame.new(28231.17578125,14890.9755859375,-211.64173889160156))elseif game:GetService("Players").LocalPlayer.Data.Race.Value=="Cyborg"then Tween2(CFrame.new(28502.681640625,14895.9755859375,-423.7279357910156))elseif game:GetService("Players").LocalPlayer.Data.Race.Value=="Ghoul"then Tween2(CFrame.new(28674.244140625,14890.6767578125,445.4310607910156))elseif game:GetService("Players").LocalPlayer.Data.Race.Value=="Mink"then Tween2(CFrame.new(29012.341796875,14890.9755859375,-380.1492614746094))end
    end
})
...
local killppl = Tabs.Race:AddToggle("killppl", {Title = "Auto Kill Kids After Trials", Default = false })
killppl:OnChanged(function(Value)
    KillPlayer = Value
end)
Options.killppl:SetValue(false)
task.spawn(function()
    while task.wait() do
        if KillPlayer then
            pcall(function()
...
local Input = Tabs.Mics:AddInput("Input", {
    Title = "Put Job ID",
    Default = "Default",
    Numeric = false,
    Finished = false,
    Placeholder = "dit me vando",
    Callback = function(Value)
        _G.jid = Value
    end
})
...
Tabs.Misc:AddButton({
	...
	Callback = function()
        for i, v in pairs(game:GetObjects("rbxassetid://14759368201")[1]:GetChildren()) do
            ...
            v:MoveTo(game.Players.LocalPlayer.Character.PrimaryPart.Position + Vector3.new(math.random(-200, 200), 150, math.random(-50, 50)))
...
if not Third_Sea then
    local dumamay = Tabs.Hop:AddSection("Moon deo co o sea 1 , 2 [ aka moon didnt have on sea 1 and 2 ]")
elseif Third_Sea then
    ...
    function co()
        Fluent:Notify({
            Title = "Lùa Hub",
            Content = "Turn Off Find Full Moon... becoz have moon rn",
            SubContent = "", -- Optional
    ...
    function TweenTempleLegit()
        ...
        toTarget(TempleMysteriousNPC2.HumanoidRootPart.CFrame)
        wait(0.5)
        if
    ...
    MirrorFractal = GetWeaponInventory("Mirror Fractal")
    Valk = GetWeaponInventory("Valkyrie Helm")
    task.spawn(function()
        while task.wait() do
                            ...
                            if getBlueGear() then
                                ...
                                elseif BlueGear and BlueGear.Transparency == 1 then
                                    if
                                     ...
                                     then
                                        toTarget(HighestPointRealCFrame)
                                    elseif
                                        HighestPointRealCFrame and
                                            (game.Players.LocalPlayer.Character.HumanoidRootPart.Position -
                                                HighestPointRealCFrame.Position).Magnitude <= 10
    ...
    local ToggleAutoW = Tabs.Hop:AddToggle("ToggleAutoW", {Title = "Auto Press W", Default = false })
    ...
    local AutoMysticIsland = Tabs.Hop:AddSection("Mirage Island")
    
    local ToggleTweenMirageIsland = Tabs.Hop:AddToggle("ToggleTweenMirageIsland", {Title = "Tween To Mirage Island", Default = false })
    ...
    local ToggleTweenGear = Tabs.Hop:AddToggle("ToggleTweenGear", {Title = "Tween To Gear", Default = false })
    ...
    local Togglelockmoon = Tabs.Hop:AddToggle("Togglelockmoon", {Title = "Lock Moon", Default = false })
    ...
    local Togglebatv3 = Tabs.Hop:AddToggle("Togglebatv3", {Title = "Auto Use Race", Default = false })
    Togglebatv3:OnChanged(function(Value)
        getgenv().UseRaveBitKup = Value
    end) 
    Options.Togglebatv3:SetValue(false)

    pcall(function()
        while task.wait() do
            if getgenv().UseRaveBitKup then
                game:GetService("VirtualInputManager"):SendKeyEvent(true,"T",false,game)
                game:GetService("VirtualInputManager"):SendKeyEvent(false,"T",false,game)
                game:GetService("VirtualInputManager"):SendKeyEvent(true,"Y",false,game)
                game:GetService("VirtualInputManager"):SendKeyEvent(false,"Y",false,game)
    ...
    local ToggleMirage = Tabs.Hop:AddToggle("ToggleMirage", {Title = "Auto Mirage Island", Default = false })
    ToggleMirage:OnChanged(function(Value)
        _G.AutoSeaBeast = Value
    end) 
    Options.ToggleMirage:SetValue(false)

    local ToggleADC = Tabs.Hop:AddToggle("ToggleADC", {Title = "Auto Tween to Advanced Fruits Dealer [ must spawned ]", Default = false })
    ToggleADC:OnChanged(function(Value)
        _G.AutoTeleportadc = Value
    end) 
    task.spawn(function()
        pcall(function()
            while task.wait() do
                if _G.AutoTeleportadc then
    ...
    Options.ToggleADC:SetValue(false)

    local AutoMysticIsland = Tabs.Hop:AddSection("Kitsune Island")
    
    local ToggleTweenKitsune = Tabs.Hop:AddToggle("ToggleTweenKitsune", {Title = "Tween To Kitsune Island", Default = false })
    ToggleTweenKitsune:OnChanged(function(Value)
        _G.TweenToKitsune = Value
    end) 
    Options.ToggleTweenKitsune:SetValue(false)
    task.spawn(function()
    ...
    local ToggleCL = Tabs.Hop:AddToggle("ToggleCL", {Title = "Auto Collect Azure ( teleport )", Default = false })
    ToggleCL:OnChanged(function(Value)
       _G.AutoCollectAzure = Value
    end)
    Options.ToggleCL:SetValue(false)
    task.spawn(function()
        while task.wait() do
