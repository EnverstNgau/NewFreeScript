...
spawn(function()
    while wait() do
        _G.BringMode = math.random(350,400)
        wait()
    end
end)
spawn(function()
...
spawn(function()
    while wait(.1) do
        ...
        elseif Type == 4 then
            Pos = CFrame.new(0,PosY,30)	
        elseif Type == 5 then
            Pos = CFrame.new(-30,PosY,10)
        elseif Type == 6 then
            Pos = CFrame.new(10,PosY,-30)
        end
    end
end)
    ...
    while wait() do
		pcall(function()
			if _G.AutoDooHee then
                ...
                local lookAtPos = game.Workspace.CurrentCamera.CFrame.p + moonDir * 200
...
--------------------------------------------------------------------------------------------------------------------------------------------
    ...
    local iuvai = Tabs.Setting:AddToggle("iuvai", {Title = "Super Fast Attack (Old)", Default = true })
