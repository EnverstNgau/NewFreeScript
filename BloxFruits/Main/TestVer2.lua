...
local Tabs = {
    ...
    Fruit = Window:AddTab({ Title = "Fruits & Esp", Icon = "cherry" }),
...
if AutoFarmQuest and (CFrameMon.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 3000 then
...
if AutoFarmQuest and (CFrameMon.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 20000 then
...
for i,v in pairs(game:GetService("Workspace").Map.MysticIsland:GetChildren()) do 
 ...
 function Tween(Pos)
        ...
        while wait() do
            skibidi = math.random(330,350)
        end
        pcall(function() tween = game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRootPart,TweenInfo.new(Distance/skibidi, Enum.EasingStyle.Linear),{CFrame = Pos}) end)
        tween:Play()
...
-- Bring Mob Select Farm
spawn(function()
    while wait() do
        _G.BringMode = math.random(390,400)
        task.wait()
    end
end)
spawn(function()
    while task.wait() do
        pcall(function()
            if _G.BringMonster then
                CheckLevel()
                for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                    if _G.AutoFarm and StartMagnet and v.Name == Ms and (Ms == "Factory Staff" or Ms == "Monkey" or Ms == "Dragon Crew Warrior" or Ms == "Dragon Crew Archer") and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 and (v.HumanoidRootPart.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= _G.BringMode then
                    ...
                    elseif _G.AutoFarm and StartMagnet and v.Name == Ms and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 and (v.HumanoidRootPart.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= _G.BringMode then
                        v.HumanoidRootPart.Size = Vector3.new(150,150,150)
                        v.HumanoidRootPart.CFrame = PosMon
                        v.Humanoid:ChangeState(14)
                        v.HumanoidRootPart.CanCollide = false
                    ...
                    if _G.AutoRengoku and StartRengokuMagnet then
                        if (Ms == "Snow Lurker" or Ms == "Arctic Warrior") and (v.HumanoidRootPart.Position - RengokuMon.Position).Magnitude <= _G.BringMode and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                    ...
                    if _G.AutoMusketeerHat and StartMagnetMusketeerhat then
                        if Ms == "Forest Pirate" and (v.HumanoidRootPart.Position - MusketeerHatMon.Position).Magnitude <= _G.BringMode and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                            v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                            v.Humanoid:ChangeState(14)
                            v.HumanoidRootPart.CanCollide = false
                            v.Head.CanCollide = false
                    ...
                    if _G.Auto_EvoRace and StartEvoMagnet then
                        if Ms == "Zombie" and (v.HumanoidRootPart.Position - PosMonEvo.Position).Magnitude <= _G.BringMode and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                            v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                            v.Humanoid:ChangeState(14)
                            v.HumanoidRootPart.CanCollide = false
                            v.Head.CanCollide = false
                    ...
                    if _G.AutoBartilo and AutoBartiloBring then
                        if Ms == "Swan Pirate" and (v.HumanoidRootPart.Position - PosMonBarto.Position).Magnitude <= _G.BringMode and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                            v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                            v.Humanoid:ChangeState(14)
                            v.HumanoidRootPart.CanCollide = false
                            v.Head.CanCollide = false
                    ...
                    if AutoFarmBone and StartMagnetBoneMon then
                        if (Ms == "Reborn Skeleton" or Ms == "Living Zombie" or Ms == "Demonic Soul" or Ms == "Posessed Mummy") and (v.HumanoidRootPart.Position - PosMonBone.Position).Magnitude <= _G.BringMode and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                            v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                            v.Humanoid:ChangeState(14)
                            v.HumanoidRootPart.CanCollide = false
                            v.Head.CanCollide = false
                    ...
                    if _G.AutoFarmCandy and StartCandyMagnet then
                        if (Ms == "Ice Cream Chef" or Ms == "Ice Cream Commander") and (v.HumanoidRootPart.Position - CandyMon.Position).Magnitude <= _G.BringMode and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                            v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                            v.Humanoid:ChangeState(14)
                            v.HumanoidRootPart.CanCollide = false
                            v.Head.CanCollide = false
                    ...
                    if AutoFarmQuest and StardMag then
                        if (Ms == "Shanda" or Ms == "Shanda") and (v.HumanoidRootPart.Position - FastMon.Position).Magnitude <= _G.BringMode and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                            v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                            v.Humanoid:ChangeState(14)
                            v.HumanoidRootPart.CanCollide = false
                            v.Head.CanCollide = false
                    ...
                    if AutoCakePrince and MagnetDought then
                        if (Ms == "Cookie Crafter" or Ms == "Cake Guard" or Ms == "Baking Staff" or Ms == "Head Baker") and (v.HumanoidRootPart.Position - PosMonDoughtOpenDoor.Position).Magnitude <= _G.BringMode and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                            v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                            v.Humanoid:ChangeState(14)
                            v.HumanoidRootPart.CanCollide = false
                            v.Head.CanCollide = false
		...
		pcall(function()
			if (p.Position-game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude >= 2000 and not Auto_Raid and game.Players.LocalPlayer.Character.Humanoid.Health > 0 then
				if NameQuest == "FishmanQuest" then
					...
					wait()
					game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(61163.8515625, 11.6796875, 1819.7841796875))
				elseif Ms == "God's Guard" or NameMon == "God's Guard" then
					Tween(game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame)
					wait()
					game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-4607.82275, 872.54248, -1667.55688))
...
spawn(function()
    while wait(2) do
local posX = math.random(15,20)
local posY = math.random(10,20)
local posZ = math.random(15,20)
    end
end)
--------------------------------------------------------------------------------------------------------------------------------------------
--Create Tabs
...
local ToggleMelee = Tabs.Main:AddToggle("ToggleMelee", {Title = "Auto Mastery All Melee", Default = false })
    ...
    while wait() do
        if AutoFarmBone then
            pcall(function()
                ...
                if (QuestBone.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 800 then    
...
if Third_Sea then
   ...
   ToggleTW:OnChanged(function(Value)
    ...
    local ToggleTerrorshark = Tabs.Main:AddToggle("ToggleTerrorshark", {Title = "Auto Terror Shark", Default = false })
    ...
    spawn(function()
        while wait() do
            if  _G.AutoTerrorshark then
                pcall(function()
                    if game:GetService("Workspace").Enemies:FindFirstChild("Terrorshark") or game:GetService("Workspace").Enemies:FindFirstChild("Terrorshark [Lv. 2000] [Raid Boss]") then
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v.Name == "Terrorshark" or v.Name == "Terrorshark [Lv. 2000] [Raid Boss]" then
                                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                    repeat task.wait()
                                        AutoHaki()
                                        EquipTool(SelectWeapon)
                    ...
                    if game:GetService("ReplicatedStorage"):FindFirstChild("Terrorshark") or game:GetService("ReplicatedStorage"):FindFirstChild("Terrorshark [Lv. 2000] [Raid Boss]") then
                        Tween(game:GetService("ReplicatedStorage"):FindFirstChild("Terrorshark").HumanoidRootPart.CFrame * CFrame.new(2,20,2))
                        Tween(game:GetService("ReplicatedStorage"):FindFirstChild("Terrorshark [Lv. 2000] [Raid Boss]").HumanoidRootPart.CFrame * CFrame.new(2,20,2))
                    else
                    end
                end
            end)
...
local togglnhon = Tabs.Main:AddToggle("togglnhon", {Title = "Lock Camera Moon", Default = false })
togglnhon:OnChanged(function(Value)
    moonseclock = Value
end)
...
local gear = Tabs.Main:AddToggle("gear", {Title = "Tween Gear", Default = false })
...
local ToggleSaber = Tabs.Main:AddToggle("ToggleSaber", {Title = "Auto Saber", Default = false })
        ...
        if AutoSaber then
            if game.Players.localPlayer.Data.Level.Value < 200 then
                ...
                if game.Workspace.Map.Jungle.Final.Part.CanCollide == false then
                    if AutoSaber and game.ReplicatedStorage:FindFirstChild("Saber Expert") or game.Workspace.Enemies:FindFirstChild("Saber Expert") then
...
--------------------------------------------------------------------------------------------------------------------------------------------
    ...
    local iuvai = Tabs.Setting:AddToggle("iuvai", {Title = "Fast Attack", Default = true })
    iuvai:OnChanged(function(vu)
    _G.FastAttack = vu
end)
-- Modules
...
function getAllBladeHitsPlayers(Sizes)
	...
	for i=1,#Characters do local v = Characters[i]
		...
		if v.Name ~= game.Players.LocalPlayer.Name and Human and Human.RootPart and Human.Health > 0 and Client:DistanceFromCharacter(Human.RootPart.Position) < Sizes + 450 then
...
function getAllBladeHits(Sizes)
	...
	for i=1,#Enemies do local v = Enemies[i]
		local Human = v:FindFirstChildOfClass("Humanoid")
		if Human and Human.RootPart and Human.Health > 0 and Client:DistanceFromCharacter(Human.RootPart.Position) < Sizes + 450 then
			table.insert(Hits,Human.RootPart)
		end
	end
	return Hits
end
function AttackThuong()
	local ac = CombatFrameworkR.activeController
	if ac and ac.equipped then
		for indexincrement = 1, 1 do
            gay = math.random(1,2)
            if gay == 1 then
			local bladehit = getAllBladeHits(550)
            elseif gay == 2 then
            local bladehit = getAllBladeHitsPlayers(550)
            else
                pcall(function()
            local bladehit = getAllBladeHits(550)
            task.wait()
...
function getHits(Size)
    ...
    for i=1,#Enemies do local v = Enemies[i]
        local Human = v:FindFirstChildOfClass("Humanoid")
        if Human and Human.RootPart and Human.Health > 0 and game.Players.LocalPlayer:DistanceFromCharacter(Human.RootPart.Position) < Size + 450 then
            table.insert(Hits,Human.RootPart)
        end
    end
    for i=1,#Characters do local v = Characters[i]
    ...
    if ac and ac.equipped then
        task.spawn(function()
            if tick() - cdnormal > 0.5 then
                ...
                game:GetService("ReplicatedStorage").RigControllerEvent:FireServer("hit", getHits(550), 2, "")
            end
        end)
    end
end
...
task.spawn(function()
    ...
    ToggleBringMob:OnChanged(function(Value)
        StardMag=Value;_G.BringMonster=Value;BringMobs = Value;MagnetDought=Value;StartCandyMagnet=Value;StartMagnetBoneMon=Value;StartMasteryGunMagnet=Value;StartMasteryFruitMagnet=Value;AutoBartiloBring=Value;StartRengokuMagnet=Value;StartMagnetMusketeerhat=Value;Mangnetcitzenmon=Value;StartEvoMagnet=Value;StartEctoplasmMagnet=Value;_G.AutoEctoplasm=Value;_G.AutoRengoku=Value;_G.AutoMusketeerHat=Value;_G.AutoObservationHakiV2=Value;_G.Auto_EvoRace=Value;_G.AutoBartilo=Value;_G.AutoFarmFruitMastery=Value;_G.AutoFarmGunMastery=Value;_G.Auto_Bone=Value;BringAcient=Value;AutoFarmAcient=Value;_G.Farmfast=Value;StartMag=Value
    end)
...
local KillCac = Tabs.Race:AddToggle("KillCac", {Title = "Auto Kill Kids After Trials", Default = false })
KillCac:OnChanged(function(Value)
                ...
                for i, v in pairs(game:GetService("Workspace").Characters:GetChildren()) do
                    if v.Name ~= game.Players.LocalPlayer.Name and (v.HumanoidRootPart.Position - Game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 100 then
                        if v.Humanoid.Health > 0 then
                            ...
                            EquipWeapon(SelectWeapon)
                            NameTarget = v.Name
                            Tween(v.HumanoidRootPart.CFrame * CFrame.new(10, 5, 0))
                            Tween(v.HumanoidRootPart.CFrame * CFrame.new(0, 15 , 10))
                            v.HumanoidRootPart.CanCollide = false
                            v.HumanoidRootPart.Size = Vector3.new(60, 60, 60)
                            Click()
...
local DropdownSelectMelee = Tabs.Shop:AddDropdown("DropdownSelectMelee", {
    Title = "Choose Melee To Buy",
    Values = {"Black Leg","Electric","Sharkman","Superhuman","Dragon Claw","Death Step","Sharkman Karate","Electric Claw","Dragon Talon","God Human","Sanguine Art"},
    Multi = false,
    Default = 1,
})
DropdownSelectMelee:SetValue("...")
DropdownSelectMelee:OnChanged(function(Value)
    SelectMelee = Value
end)
Tabs.Shop:AddButton({
    Title = "Buy Select Melee",
    Description = "",
    Callback = function()
if SelectMelee == "Black Leg" then
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyBlackLeg")
elseif SelectMelee == "Electric" then
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectro")
...
elseif SelectMelee == "God Human" then
...
local DropdownSelectGun = Tabs.Shop:AddDropdown("DropdownSelectGun", {
    Title = "Choose Gun To Buy",
    Values = {"Refined Flintlock","Slingshot","Musket","Flintlock","Cannon","Kabucha","Bizarre Rifle"},
    Multi = false,
    Default = 1,
})
DropdownSelectGun:SetValue("...")
DropdownSelectGun:OnChanged(function(Value)
    SelectGun = Value
end)
Tabs.Shop:AddButton({
    Title = "Buy Select Gun",
    Description = "",
    Callback = function()
if SelectGun == "Refined Flintlock" then
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Refined Flintlock")
elseif SelectGun == "Slingshot" then
...
Tabs.Shop:AddButton({
    Title = "Duel Katana ( A.K.A Dual Katana)",
    Description = "12000$",
    Callback = function()
